...
# catalog as of 2026-08, into the 4 categories fragrance-decant buyers
# actually shop by: "designer" (mall/department-store fashion houses),
# "niche" (smaller artisanal/perfumery-first houses), "dupe" (brands
# whose business model is explicitly inspired-by/clone releases of
# designer or niche originals -- mostly budget Gulf houses), and "local"
# (established Middle Eastern/Gulf heritage brands -- oud houses,
# regional prestige lines -- that aren't primarily dupe-positioned).
...
# signal for which of these 4 buckets a brand-new house belongs to.
BRAND_CATEGORY = {
    '17/17': 'niche',
    'abdul samad al qurashi': 'local',
    'abyed': 'local',
    'acqua di parma': 'niche',
    'adidas': 'designer',
    'afnan': 'dupe',
    'ahmed al maghribi': 'local',
    'aigner': 'designer',
    'ajmal': 'local',
    'al ezz lel oud': 'local',
    'al ezz oud': 'local',
    'al fares': 'dupe',
    'al haramain': 'local',
    'al majed 4 oud': 'local',
    'al majed oud': 'local',
    'al rehab': 'local',
    'al wataniah': 'dupe',
    'alexandre j': 'niche',
    ...
    'arabiyat sugar': 'dupe',
    'aramis': 'designer',
    'ard al zaafaran': 'local',
    'ard al zaafran': 'local',
    ...
    'athena': 'dupe',
    'athoor al alam': 'local',
    'atkinsons': 'niche',
    'atralia': 'dupe',
    'atyab al marshood': 'local',
    'atyab al sheekh': 'local',
    'azuree': 'designer',
    'azurée': 'designer',
    'azzaro': 'designer',
    ...
    'my perfume': 'dupe',
    'mykonos': 'dupe',
    'najla abdul samad al qurashi': 'local',
