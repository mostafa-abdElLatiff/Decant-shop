...
WEB_STORE_NAMES = {"roseperfume", "sniffz", "MO Shawky", "eldesoki-fragrances", "emaratiscents", "dar.elarabia", "perfuzone", "og-perfume", "feel22", "mazaya"}
...
# One-time editorial classification of every distinct brand seen in the
# catalog as of 2026-08, into the 3 categories fragrance-decant buyers
# actually shop by: "designer" (mall/department-store fashion houses),
# "niche" (smaller artisanal/perfumery-first houses -- including Gulf/
# Middle Eastern heritage houses that create their own original
# compositions, e.g. Amouage, Oman Luxury, Arabian Oud), and "dupe"
# (brands whose business model is explicitly inspired-by/clone releases
# of designer or niche originals -- not just the budget Western-style
# houses, but also several large, long-established Gulf houses whose
# current catalog turned out to be primarily clone-driven once actually
# researched: Rasasi, Khadlaj, Ibrahim Al Qurashi/Ibraq, Al Haramain,
# Ahmed Al Maghribi, Ard Al Zaafaran, Gulf Orchid, Nusuk among them --
# "established Gulf heritage house" alone is NOT a reliable signal for
# "niche"; a plain "local" bucket used to exist for exactly that wrong
# assumption and was removed in favor of researching each brand.
# Keyed by the CANONICALIZED, lowercased brand string so every raw
# spelling variant of the same real house still resolves correctly.
# New brands this catalog hasn't seen before simply fall through to ""
# (unknown) until added here by hand -- there's no reliable automatic
# signal for which of these 3 buckets a brand-new house belongs to.
BRAND_CATEGORY = {
    '17/17': 'niche',
    ...
    'alexandre j': 'niche',
    'alexandre.j': 'niche',
    'alfred dunhill': 'designer',
    'alhambra': 'dupe',
    'almas': 'niche',
    'almas perfumes': 'niche',
    'almusbah blend': 'dupe',
    'amaran': 'dupe',
    'amouage': 'niche',
    'amouroud': 'niche',
    'anonymous': 'dupe',
    'antonio banderas': 'designer',
    'antonio puig': 'designer',
    'arabian oud': 'niche',
    'arabiyat': 'dupe',
    'arabiyat prestige': 'dupe',
    'arabiyat sugar': 'dupe',
    'aramis': 'designer',
    'ard al zaafaran': 'dupe',
    'ard al zaafran': 'dupe',
    'ariana grande': 'designer',
    'armaf': 'dupe',
    'armani': 'designer',
    ...
    'atkinsons': 'niche',
    'atralia': 'dupe',
    'atyab al marshood': 'niche',
    'atyab al sheekh': 'niche',
    'azuree': 'designer',
    'azurée': 'designer',
    'azzaro': 'designer',
    ...
    'camara': 'dupe',
    'camara perfumes': 'dupe',
    'canaria': 'dupe',
    'carolina herrera': 'designer',
    'carrera': 'designer',
    'carrera jeans': 'designer',
    'cartier': 'designer',
    'casamorati': 'niche',
    'cerruti': 'designer',
    'cesium': 'dupe',
    ...
    'creative art': 'dupe',
    'creed': 'niche',
    'cristiano ronaldo': 'designer',
    'datura perfumes': 'niche',
    'david walter': 'dupe',
    'davidoff': 'designer',
    'designer': 'designer',
    'diesel': 'designer',
    ...
    'dkhoni': 'niche',
    'dkhoon': 'niche',
    'dkhoon emirates': 'niche',
    'dkhooni': 'niche',
    'dkny': 'designer',
    'dolce & gabbana': 'designer',
    'dolce and gabbana': 'designer',
    'dolce&gabbana': 'designer',
    'dolce&gabbana!': 'designer',
    'dumont': 'designer',
    'dumont paris': 'designer',
    'dunhill': 'designer',
    'dyrose': 'dupe',
    'elie saab': 'designer',
    'elite risala': 'dupe',
    'elizabeth arden': 'designer',
    'ella k': 'niche',
    'emir': 'dupe',
    'emper': 'dupe',
    ...
    'gisada': 'designer',
    'gissah': 'niche',
    'gissah fragrances': 'niche',
    'givenchy': 'designer',
    'golden collections': 'dupe',
    'goldfield & banks': 'niche',
    ...
    'jaguar': 'designer',
    'jaguar classic black': 'designer',
    'jean antoine': 'niche',
    'jean paul gaultier': 'designer',
    'jimmy choo': 'designer',
    'jo malone': 'designer',
    'jo malone london': 'designer',
    ...
    'jovoy paris': 'niche',
    'jozoor': 'niche',
    'juliette has a gun': 'designer',
    'karl lagerfeld': 'designer',
    'kayali': 'niche',
    'kenzo': 'designer',
    'khadlaj': 'dupe',
    'khadlaj perfumes': 'dupe',
    'kilian': 'niche',
    'killian': 'niche',
    'korloff': 'niche',
    "l'arc": 'niche',
    ...
    'laverne': 'dupe',
    'le bonheur': 'dupe',
    'le bonheur parfums': 'dupe',
    'le bonheur perfumes': 'dupe',
    'le chameau': 'dupe',
    'le falcone': 'niche',
    'le falconé': 'niche',
    'le falconé perfumes': 'niche',
    'le gazelle': 'dupe',
    'liquides imaginaires': 'niche',
    'loewe': 'designer',
    'lorenzo pazzaglia': 'niche',
    'lorenzo villoresi': 'niche',
    'lorenzo villoresi firenze': 'niche',
    ...
    'maison martin margiela': 'niche',
    'maison noir': 'niche',
    "mama's": 'dupe',
    'mamlakat al oud': 'dupe',
    'mancera': 'niche',
    ...
    'memo': 'niche',
    'memo paris': 'niche',
    'memoirs of a perfume collector': 'niche',
    'mendes': 'dupe',
    'mercedes benz': 'designer',
    'mercedes-benz': 'designer',
    'michael cinco': 'designer',
    ...
    'my perfume': 'dupe',
    'mykonos': 'dupe',
    'najla abdul samad al qurashi': 'niche',
    ...
    'paris blue parfums': 'dupe',
    'paris corner': 'dupe',
    'parour': 'dupe',
    'pendora scents': 'dupe',
    "penhaligon's": 'niche',
    'penhaligons': 'niche',
    'philip plein': 'designer',
    ...
    'riffs': 'dupe',
    'riiffs': 'dupe',
    'riiffs perfumes': 'dupe',
    'risala': 'dupe',
    'risvelium': 'dupe',
    'roberto cavalli': 'designer',
    'rochas': 'designer',
    'roger & gallet': 'designer',
    'roger and gallet': 'designer',
    'roja': 'niche',
    'roja parfums': 'niche',
    'room 1015': 'niche',
    'rosendo mateu': 'niche',
    ...
    'serge lutens': 'niche',
    'sir. francis': 'niche',
    'smart collection': 'dupe',
    'sospiro': 'niche',
    'spongebob': 'designer',
    'stephane humbert lucas': 'niche',
    'stephane humbert lucas paris': 'niche',
    'sterling perfumes': 'dupe',
    'stéphane humbert lucas 777': 'niche',
    'swiss arabian': 'niche',
    'taif al emarat': 'dupe',
    ...
    'victorinox': 'designer',
    'victorioso': 'dupe',
    'viktor and rolf': 'designer',
    'viktor&rolf': 'designer',
    'vitality': 'dupe',
    'volare': 'dupe',
    'wadi al khaleej': 'dupe',
    'western perfumeur': 'dupe',
    'xerjoff': 'niche',
    'ysl': 'designer',
    'yves rocher': 'designer',
...
def brand_category(brand: str) -> str:
    """One of "designer"/"niche"/"dupe"/"local", or "" (unknown) for a
    blank/not-yet-classified brand -- never guessed, since a wrong
    category is worse than an honestly-empty one for a filter users
